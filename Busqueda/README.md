...
I copied over the scripts in this repository for the sake of documentation in the [gitea-administrator-scripts](Busqueda/gitea-administrator-scripts) folder.
